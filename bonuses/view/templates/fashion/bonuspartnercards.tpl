...
<div class="bonusPartnerCardsWrapper fashion personalAccount">
    <div class="form-style">
        ...
        <div class="buttons cboth">
            <a href="{$router->getUrl('bonuses-front-bonuspartnercards', ['Act'=>'add'])}" class="formSave button color inDialog rs-in-dialog">{t}Добавить карту{/t}</a>
        </div>
    </div>
</div>