...
<div class="bonusPartnerCardsWrapper flatlines personalAccount">
    <div class="form-style">
        <div class="tab-content">
            <div>
                <h3 class="h3">{t}Партнерские бонусные карты{/t}</h3>
                <div>
                    <a href="{$router->getUrl('bonuses-front-bonuspartnercards', ['Act'=>'add'])}" class="link link-more inDialog rs-in-dialog">{t}Добавить карту{/t}</a>
                    {if !empty($list)}
                        <hr/>
