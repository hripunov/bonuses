...
<div class="bonusPartnerCardsWrapper default personalAccount">
    <div class="form-style">
        ...
        <a href="{$router->getUrl('bonuses-front-bonuspartnercards', ['Act'=>'add'])}" class="formSave inDialog rs-in-dialog">{t}Добавить карту{/t}</a>
    </div>
</div>