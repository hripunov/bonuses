...
{*<div style="background-color: #e2f2ef; border-radius: 10px; padding: 15px; text-align: center;">
<p style="text-transform: uppercase; font-weight: 600;">Работа интернет-магазина в праздники</p>
<p>12 июня &mdash; интернет-магазин не работает.<br />Заказы оформленные в этот день будут обработаны и переданы в доставку 13 июня.</p>
</div>*}
